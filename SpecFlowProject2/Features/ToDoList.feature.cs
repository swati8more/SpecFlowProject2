...
#line hidden
        ...
        [NUnit.Framework.DescriptionAttribute("Verify that a user can create a new task with a valid title")]
        [NUnit.Framework.CategoryAttribute("ui")]
        public virtual void VerifyThatAUserCanCreateANewTaskWithAValidTitle()
        {
            string[] tagsOfScenario = new string[] {
                    "ui"};
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Verify that a user can create a new task with a valid title", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 4
...
#line hidden
#line 7
 testRunner.Then("User able to added task in the to do list", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
